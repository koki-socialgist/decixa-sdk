 ...
 */
export type SortOption = "relevance" | "price_asc" | "price_desc" | "latency_asc" | "trust" | "calls";
export type SearchMode = "vector" | "db_fallback";
export type RecommendationStatus = "resolved" | "no_match";
export type NoMatchReason = "low_semantic_similarity" | "insufficient_verified_pool_for_intent";
